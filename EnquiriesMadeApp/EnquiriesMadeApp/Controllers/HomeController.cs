...
namespace EnquiriesMadeApp.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<JsonResult> PostData(string name,string email,string phone,string emailnotification,string whatsappnotification, string smsnotification, string facebooknotification)
        {
            ...
            if (facebooknotification == "1")
            {
                //var pagePost = fblogic.GetPagePostDetails("102148735055937");

                string fbPostId = "102148735055937_102151718388972";
                string replyMessage = "Product Name: Mixed Zinger Doubles Price: Rs.289 Buy Now: https://online.kfc.co.in/menu/burgers";
                var fbPostDetails = fblogic.GetPostDetails(fbPostId, replyMessage);
            }
